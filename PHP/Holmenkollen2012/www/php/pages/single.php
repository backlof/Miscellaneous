...
{
	echo '<h3>Admin-side</h3>';
	echo '<p>Her skal det være mulig å legge til og fjerne utøvere og tilskuere. Denne siden kommer du ikke til hvis du ikke er logget inn som admin.</p>';
}
else
{
	echo '<p>Denne siden er uferdig.</p>';
	// OM ØVELSE
